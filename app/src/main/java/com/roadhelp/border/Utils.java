...
public class Utils {
    ...
    public static final String DESCR_2 = "Погранпереход Мамоново — Гроново \\ Бранево\n" +
            "Режим работы? Круглосуточно, без выходных.\n" +
            "На чем можно пересекать? Автомобиль, автобус.\n" +
            "Можно ли пересечь пешком? Нет.\n" +
            "Можно ли пересечь на велосипеде? Да, по предварительной заявке по тел.: +7 (40156) 40488";
    public static final String DESCR_3 = "Погранпереход Гусев (Озерск) — Голдап\n" +
            "Режим работы? Круглосуточно, без выходных.\n" +
            "На чем можно пересекать? Автомобиль, автобус.\n" +
            "Можно ли пересечь пешком? Да.\n" +
            "Можно ли пересечь на велосипеде? Да.";
    public static final String DESCR_4 = "Погранпереход Мамоново — Гжехотки\n" +
            "Режим работы? Круглосуточно, без выходных.\n" +
            "На чем можно пересекать? Автомобиль, автобус.\n" +
            "Можно ли пересечь пешком? Нет.\n" +
            "Можно ли пересечь на велосипеде? Нет.";

    public static final String DESCR_5 = "Погранпереход Советск - Панемуне\nавтомобильный \n24 часа \nдля всех паспортов \nпешком разрешается \nна велосипеде разрешается, тел. (40161) 32022";
